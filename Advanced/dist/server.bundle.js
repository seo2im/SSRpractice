...
var _profile = _interopRequireDefault(__webpack_require__(9));
...
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    ...
    _common.prerenderPages[page] = pageHtml;
  }
} catch (err) {
  _iterator.e(err);
} finally {
...
app.get('*', function (req, res) {
  ...
  var pageHtml = _common.prerenderPages.includes(page) ? _common.prerenderPages[page] : (0, _common.renderPage)(page);
